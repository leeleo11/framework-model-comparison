...
def build_analysis(engine: OSISEngine) -> None:
    ...
    engine.settlement.group.create("桥台1沉降组", -0.011, 80, 81)
    engine.settlement.group.create("桥台2沉降组", -0.011, 86, 87)
    # 创建沉降荷载工况
    ...
    engine.live.lane.create("右偏载工况车道1", "VE", 115.0, 1.8, 1, 0, "主梁单元", -4.475, 0.0)
    engine.live.lane.create("右偏载工况车道2", "VE", 115.0, 1.8, 1, 0, "主梁单元", -1.375, 0.0)
    engine.live.lane.create("中载工况车道1", "VE", 115.0, 1.8, 1, 0, "主梁单元", -1.55, 0.0)
    engine.live.lane.create("中载工况车道2", "VE", 115.0, 1.8, 1, 0, "主梁单元", 1.55, 0.0)
    engine.live.lane.create("左偏载工况车道1", "VE", 115.0, 1.8, 1, 0, "主梁单元", 4.475, 0.0)
    engine.live.lane.create("左偏载工况车道2", "VE", 115.0, 1.8, 1, 0, "主梁单元", 1.375, 0.0)
    # 创建活载工况
