...
def build_boundaries(engine: OSISEngine) -> None:
    ...
    engine.boundary.get(2).assign("a", 53)
    ...
    engine.boundary.get(5).assign("a", 55)
    ...
    engine.boundary.get(17).assign("a", "48to50")
    engine.boundary.create(18, "GENERAL", "", 1, 1, 1, 1, 0, 0, 0)
    engine.boundary.get(18).assign("a", 51)
    # 创建边界组
