...
def build_analysis(engine: OSISEngine) -> None:
    # 创建或修改沉降组
    engine.settlement.group.create("桥墩1沉降组", -0.015, 74, 75)
    engine.settlement.group.create("桥墩2沉降组", -0.015, 76, 77)
    engine.settlement.group.create("桥台1沉降组", -0.012, 72, 73)
    engine.settlement.group.create("桥台2沉降组", -0.012, 78, 79)
    # 创建沉降荷载工况
    ...
    engine.live.lane.create("右偏载工况车道1", "VE", 90.0, 1.8, 1, 0, "主梁单元", -4.475, 0.0)
    engine.live.lane.create("右偏载工况车道2", "VE", 90.0, 1.8, 1, 0, "主梁单元", -1.375, 0.0)
    engine.live.lane.create("中载工况车道1", "VE", 90.0, 1.8, 1, 0, "主梁单元", -1.55, 0.0)
    engine.live.lane.create("中载工况车道2", "VE", 90.0, 1.8, 1, 0, "主梁单元", 1.55, 0.0)
    engine.live.lane.create("左偏载工况车道1", "VE", 90.0, 1.8, 1, 0, "主梁单元", 4.475, 0.0)
    engine.live.lane.create("左偏载工况车道2", "VE", 90.0, 1.8, 1, 0, "主梁单元", 1.375, 0.0)
    # 创建活载工况
