...
def build_sections(engine: OSISEngine) -> None:
    ...
    engine.section.create(1, "标准截面", "SMALLBOX", "Left", 1.4, 1.65, 1.2, 0.0, 1.0, 0.18, 0.2, 0.2, 3.5, 0.18, 0.25, 0.2, 0.15, 0.25, 0.05, 0.05, 0, 0.0, 0.0, 0.05)
    # 设置截面偏移。
    engine.section.get(1).set_offset("Middle", 0.1194, "Top", 0.0)
    # 设置截面网格。
    ...
    engine.section.create(4, "墩顶截面", "SMALLBOX", "Left", 1.4, 1.65, 1.2, 0.0, 1.0, 0.18, 0.3, 0.3, 3.5, 0.18, 0.25, 0.2, 0.15, 0.25, 0.05, 0.05, 0, 0.0, 0.0, 0.05)
    engine.section.get(4).set_offset("Middle", 0.0979, "Top", 0.0)
    engine.section.get(4).set_mesh(0, 0.1)
    engine.section.create(5, "加厚截面", "SMALLBOX", "Left", 1.4, 1.65, 1.2, 0.0, 1.0, 0.18, 0.3, 0.3, 3.5, 0.18, 0.25, 0.2, 0.15, 0.25, 0.05, 0.05, 0, 0.0, 0.0, 0.05)
    engine.section.get(5).set_offset("Middle", 0.0979, "Top", 0.0)
