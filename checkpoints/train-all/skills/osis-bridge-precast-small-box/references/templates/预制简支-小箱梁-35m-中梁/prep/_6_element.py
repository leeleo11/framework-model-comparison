...
def build_elements(engine: OSISEngine) -> None:
    ...
    engine.element.create(19, "BEAM3D", 19, 20, 1, 1, 6, 1, 1, 0.0, 0, 0.0, 0)
    engine.element.create(20, "BEAM3D", 20, 21, 1, 6, 3, 1, 1, 0.0, 0, 0.0, 0)
    engine.element.create(21, "BEAM3D", 21, 22, 1, 2, 2, 1, 1, 0.0, 0, 0.0, 0)
    engine.element.create(22, "BEAM3D", 22, 23, 1, 2, 2, 1, 1, 0.0, 0, 0.0, 0)
    # 分配或重置单个单元的理论厚度
    engine.prop.assign_component_thickness(0.3429, "a", "1to2", "21to22")
    engine.prop.assign_component_thickness(0.3184, "a", 3, 20)
    engine.prop.assign_component_thickness(0.2434, "a", "5to18")
    engine.prop.assign_component_thickness(0.2687, "a", 4, 19)
    # 创建单元组
    engine.element.group.create("钢束-1-N1线型单元", "c")
    engine.element.group.create("钢束-1-N1线型单元", "a", "1to22")
    engine.element.group.create("钢束-2-N2线型单元", "c")
    engine.element.group.create("钢束-2-N2线型单元", "a", "1to22")
    engine.element.group.create("钢束-3-N3线型单元", "c")
    engine.element.group.create("钢束-3-N3线型单元", "a", "1to22")
    engine.element.group.create("钢束-4-N4线型单元", "c")
    engine.element.group.create("钢束-4-N4线型单元", "a", "1to22")
    engine.element.group.create("钢束-5-N5线型单元", "c")
    engine.element.group.create("钢束-5-N5线型单元", "a", "1to22")
    engine.element.group.create("主梁单元", "c")
    engine.element.group.create("主梁单元", "a", "1to22")
