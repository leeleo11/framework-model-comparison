...
def build_elements(engine: OSISEngine) -> None:
    ...
    engine.element.create(18, "BEAM3D", 18, 19, 1, 1, 3, 1, 1, 0.0, 0, 0.0, 0)
    engine.element.create(19, "BEAM3D", 19, 20, 1, 2, 2, 1, 1, 0.0, 0, 0.0, 0)
    engine.element.create(20, "BEAM3D", 20, 21, 1, 2, 2, 1, 1, 0.0, 0, 0.0, 0)
    # 分配或重置单个单元的理论厚度
    engine.prop.assign_component_thickness(0.3171, "a", "1to2", "19to20")
    engine.prop.assign_component_thickness(0.281, "a", 3, 18)
    engine.prop.assign_component_thickness(0.2449, "a", "4to17")
    # 创建单元组
    ...
    engine.element.group.create("钢束-5-N5线型单元", "a", "1to20")
