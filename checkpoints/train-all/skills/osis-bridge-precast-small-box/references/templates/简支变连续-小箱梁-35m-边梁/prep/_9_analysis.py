...
def build_analysis(engine: OSISEngine) -> None:
    ...
    engine.live.lane.create("车道", "VE", 34.42, 1.8, 1, 0, "主梁单元", 0.0, 0.0)
    # 创建活载工况
    ...
    # scalar=横向分布系数(边梁典型 0.85)
    engine.live.case.get("车道荷载包络").include("a", "车道荷载工况1", "简支变连续小箱梁移动荷载", 0.85, 1, "CUSTOM", 7.31347, "车道")
    # 设置活载子工况的加载车道数范围
