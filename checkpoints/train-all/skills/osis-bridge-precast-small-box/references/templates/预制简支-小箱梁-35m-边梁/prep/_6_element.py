...
def build_elements(engine: OSISEngine) -> None:
    ...
    # 分配或重置单个单元的理论厚度
    engine.prop.assign_component_thickness(0.333, "a", "1to2", "21to22")
    engine.prop.assign_component_thickness(0.3107, "a", 3, 20)
    engine.prop.assign_component_thickness(0.2651, "a", 4, 19)
    engine.prop.assign_component_thickness(0.242, "a", "5to18")
    # 创建单元组
