...
def build_elements(engine: OSISEngine) -> None:
    ...
    engine.prop.assign_component_thickness(0.3477, "a", "1to2", "23to24")
    engine.prop.assign_component_thickness(0.2768, "a", 4, 21)
    engine.prop.assign_component_thickness(0.3243, "a", 3, 22)
    engine.prop.assign_component_thickness(0.2526, "a", "5to20")
    # 创建单元组
