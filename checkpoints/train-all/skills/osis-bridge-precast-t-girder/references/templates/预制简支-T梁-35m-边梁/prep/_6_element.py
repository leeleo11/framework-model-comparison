...
def build_elements(engine: OSISEngine) -> None:
    ...
    # 分配或重置单个单元的理论厚度
    engine.prop.assign_component_thickness(0.331, "a", "1to2", "23to24")
    engine.prop.assign_component_thickness(0.3199, "a", 3, 22)
    engine.prop.assign_component_thickness(0.294, "a", 4, 21)
    engine.prop.assign_component_thickness(0.2626, "a", 5, 20)
    engine.prop.assign_component_thickness(0.2303, "a", 6, 19)
    engine.prop.assign_component_thickness(0.2148, "a", "7to18")
    # 创建单元组
