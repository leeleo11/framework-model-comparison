...
def build_elements(engine: OSISEngine) -> None:
    ...
    # 分配或重置单个单元的理论厚度
    engine.prop.assign_component_thickness(0.217, "a", "5to15")
    engine.prop.assign_component_thickness(0.2426, "a", 4)
    engine.prop.assign_component_thickness(0.3097, "a", "1to2", "18to19")
    engine.prop.assign_component_thickness(0.289, "a", 3)
    engine.prop.assign_component_thickness(0.2485, "a", 16)
    engine.prop.assign_component_thickness(0.2949, "a", 17)
    # 创建单元组
