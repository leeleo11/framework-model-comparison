...
def build_elements(engine: OSISEngine) -> None:
    ...
    engine.element.create(13, "BEAM3D", 13, 14, 1, 1, 6, 1, 1, 0.0, 0, 0.0, 0)
    engine.element.create(14, "BEAM3D", 14, 15, 1, 6, 3, 1, 1, 0.0, 0, 0.0, 0)
    engine.element.create(15, "BEAM3D", 15, 16, 1, 2, 2, 1, 1, 0.0, 0, 0.0, 0)
    engine.element.create(16, "BEAM3D", 16, 17, 1, 2, 2, 1, 1, 0.0, 0, 0.0, 0)
    # 分配或重置单个单元的理论厚度
    engine.prop.assign_component_thickness(0.2179, "a", "5to12")
    engine.prop.assign_component_thickness(0.2993, "a", "1to2", "15to16")
    engine.prop.assign_component_thickness(0.2809, "a", 3, 14)
    engine.prop.assign_component_thickness(0.2402, "a", 4, 13)
    # 创建单元组
