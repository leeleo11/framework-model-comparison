...
def build_elements(engine: OSISEngine) -> None:
    ...
    engine.element.create(3, "BEAM3D", 3, 4, 1, 3, 7, 1, 1, 0.0, 0, 0.0, 0)
    engine.element.create(4, "BEAM3D", 4, 5, 1, 7, 6, 1, 1, 0.0, 0, 0.0, 0)
    engine.element.create(5, "BEAM3D", 5, 6, 1, 6, 5, 1, 1, 0.0, 0, 0.0, 0)
    engine.element.create(6, "BEAM3D", 6, 7, 1, 5, 1, 1, 1, 0.0, 0, 0.0, 0)
    ...
    engine.element.create(19, "BEAM3D", 19, 20, 1, 1, 10, 1, 1, 0.0, 0, 0.0, 0)
    engine.element.create(20, "BEAM3D", 20, 21, 1, 10, 9, 1, 1, 0.0, 0, 0.0, 0)
    engine.element.create(21, "BEAM3D", 21, 22, 1, 9, 8, 1, 1, 0.0, 0, 0.0, 0)
    engine.element.create(22, "BEAM3D", 22, 23, 1, 8, 3, 1, 1, 0.0, 0, 0.0, 0)
    engine.element.create(23, "BEAM3D", 23, 24, 1, 2, 2, 1, 1, 0.0, 0, 0.0, 0)
    engine.element.create(24, "BEAM3D", 24, 25, 1, 2, 2, 1, 1, 0.0, 0, 0.0, 0)
    # 分配或重置单个单元的理论厚度
    engine.prop.assign_component_thickness(0.3407, "a", "1to2", "23to24")
    engine.prop.assign_component_thickness(0.2325, "a", 6, 19)
    engine.prop.assign_component_thickness(0.3287, "a", 3, 22)
    engine.prop.assign_component_thickness(0.3008, "a", 4, 21)
    engine.prop.assign_component_thickness(0.2671, "a", 5, 20)
    engine.prop.assign_component_thickness(0.2158, "a", "7to18")
    # 创建单元组
