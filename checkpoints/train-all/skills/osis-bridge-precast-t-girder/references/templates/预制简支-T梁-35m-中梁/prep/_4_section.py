...
def build_sections(engine: OSISEngine) -> None:
    ...
    engine.section.create(1, "标准截面", "TGIRDER", "Middle", 2.3, 1.125, 0.875, 0.0, 0.2, 0.25, 0.6, 0.2, 0.6, 0.2, 0.2, 0, 0.0, 0.0, 0.05)
    # 设置截面偏移。
    engine.section.get(1).set_offset("Middle", 0.0, "Top", 0.0)
    # 设置截面网格。
    engine.section.get(1).set_mesh(0, 0.1)
    engine.section.create(2, "墩顶截面", "TGIRDER", "Middle", 2.3, 1.125, 0.875, 0.0, 0.2, 0.25, 0.5, 0.4, 0.6, 0.9, 0.1, 0, 0.0, 0.0, 0.05)
    engine.section.get(2).set_offset("Middle", 0.0, "Top", 0.0)
    engine.section.get(2).set_mesh(0, 0.1)
    engine.section.create(3, "加厚截面", "TGIRDER", "Middle", 2.3, 1.125, 0.875, 0.0, 0.2, 0.25, 0.5, 0.4, 0.6, 0.9, 0.1, 0, 0.0, 0.0, 0.05)
    engine.section.get(3).set_offset("Middle", 0.0, "Top", 0.0)
    engine.section.get(3).set_mesh(0, 0.1)
    engine.section.create(5, "截面1", "TGIRDER", "Middle", 2.3, 1.125, 0.875, 0.0, 0.2, 0.25, 0.577, 0.246, 0.6, 0.3611, 0.177, 0, 0.0, 0.0, 0.05)
    engine.section.get(5).set_offset("Middle", 0.0, "Top", 0.0)
    engine.section.get(5).set_mesh(0, 0.1)
    engine.section.create(6, "截面2", "TGIRDER", "Middle", 2.3, 1.125, 0.875, 0.0, 0.2, 0.25, 0.55, 0.3, 0.6, 0.55, 0.15, 0, 0.0, 0.0, 0.05)
    engine.section.get(6).set_offset("Middle", 0.0, "Top", 0.0)
    engine.section.get(6).set_mesh(0, 0.1)
    engine.section.create(7, "截面3", "TGIRDER", "Middle", 2.3, 1.125, 0.875, 0.0, 0.2, 0.25, 0.523, 0.354, 0.6, 0.7389, 0.123, 0, 0.0, 0.0, 0.05)
    engine.section.get(7).set_offset("Middle", 0.0, "Top", 0.0)
    engine.section.get(7).set_mesh(0, 0.1)
    engine.section.create(8, "截面4", "TGIRDER", "Middle", 2.3, 1.125, 0.875, 0.0, 0.2, 0.25, 0.523, 0.354, 0.6, 0.7389, 0.123, 0, 0.0, 0.0, 0.05)
    engine.section.get(8).set_offset("Middle", 0.0, "Top", 0.0)
    engine.section.get(8).set_mesh(0, 0.1)
    engine.section.create(9, "截面5", "TGIRDER", "Middle", 2.3, 1.125, 0.875, 0.0, 0.2, 0.25, 0.55, 0.3, 0.6, 0.55, 0.15, 0, 0.0, 0.0, 0.05)
    engine.section.get(9).set_offset("Middle", 0.0, "Top", 0.0)
    engine.section.get(9).set_mesh(0, 0.1)
    engine.section.create(10, "截面6", "TGIRDER", "Middle", 2.3, 1.125, 0.875, 0.0, 0.2, 0.25, 0.577, 0.246, 0.6, 0.3611, 0.177, 0, 0.0, 0.0, 0.05)
