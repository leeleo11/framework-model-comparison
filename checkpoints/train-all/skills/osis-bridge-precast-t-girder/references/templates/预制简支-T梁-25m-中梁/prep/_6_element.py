...
def build_elements(engine: OSISEngine) -> None:
    ...
    engine.element.create(16, "BEAM3D", 16, 17, 1, 1, 6, 1, 1, 0.0, 0, 0.0, 0)
    engine.element.create(17, "BEAM3D", 17, 18, 1, 6, 3, 1, 1, 0.0, 0, 0.0, 0)
    engine.element.create(18, "BEAM3D", 18, 19, 1, 2, 2, 1, 1, 0.0, 0, 0.0, 0)
    engine.element.create(19, "BEAM3D", 19, 20, 1, 2, 2, 1, 1, 0.0, 0, 0.0, 0)
    # 分配或重置单个单元的理论厚度
    engine.prop.assign_component_thickness(0.3192, "a", "1to2", "18to19")
    engine.prop.assign_component_thickness(0.2967, "a", 3)
    engine.prop.assign_component_thickness(0.2462, "a", 4)
    engine.prop.assign_component_thickness(0.2184, "a", "5to15")
    engine.prop.assign_component_thickness(0.303, "a", 17)
    engine.prop.assign_component_thickness(0.2526, "a", 16)
    # 创建单元组
    engine.element.group.create("钢束-1-N1线型单元", "c")
    engine.element.group.create("钢束-1-N1线型单元", "a", "1to19")
    engine.element.group.create("钢束-2-N2线型单元", "c")
    engine.element.group.create("钢束-2-N2线型单元", "a", "1to19")
    engine.element.group.create("钢束-3-N3线型单元", "c")
    engine.element.group.create("钢束-3-N3线型单元", "a", "1to19")
    engine.element.group.create("钢束-4-N4线型单元", "c")
    engine.element.group.create("钢束-4-N4线型单元", "a", "1to19")
    engine.element.group.create("主梁单元", "c")
    engine.element.group.create("主梁单元", "a", "1to19")
