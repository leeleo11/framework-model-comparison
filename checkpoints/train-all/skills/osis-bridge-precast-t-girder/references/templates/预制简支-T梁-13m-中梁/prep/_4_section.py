...
def build_sections(engine: OSISEngine) -> None:
    ...
    engine.section.create(1, "标准截面", "TGIRDER", "Middle", 0.75, 1.125, 0.6, 0.0, 0.18, 0.33, 0.2, 0.35, 0.35, 0.1, 0.1, 0, 0.0, 0.0, 0.0)
    # 设置截面偏移。
    engine.section.get(1).set_offset("Middle", 0.0, "Top", 0.0)
    # 设置截面网格。
    engine.section.get(1).set_mesh(0, 0.1)
    engine.section.create(2, "墩顶截面", "TGIRDER", "Middle", 0.75, 1.125, 0.6, 0.0, 0.18, 0.33, 0.2, 0.35, 0.35, 0.1, 0.1, 0, 0.0, 0.0, 0.0)
    engine.section.get(2).set_offset("Middle", 0.0, "Top", 0.0)
    engine.section.get(2).set_mesh(0, 0.1)
    engine.section.create(3, "加厚截面", "TGIRDER", "Middle", 0.75, 1.125, 0.6, 0.0, 0.18, 0.33, 0.2, 0.35, 0.35, 0.1, 0.1, 0, 0.0, 0.0, 0.0)
