...
def build_sections(engine: OSISEngine) -> None:
    ...
    engine.section.create(1, "标准截面", "TGIRDER", "Middle", 1.5, 1.125, 0.8, 0.0, 0.2, 0.25, 0.6, 0.2, 0.6, 0.2, 0.2, 0, 0.0, 0.0, 0.05)
    # 设置截面偏移。
    engine.section.get(1).set_offset("Middle", 0.0, "Top", 0.0)
    # 设置截面网格。
    engine.section.get(1).set_mesh(0, 0.1)
    engine.section.create(2, "墩顶截面", "TGIRDER", "Middle", 1.5, 1.125, 0.8, 0.0, 0.2, 0.25, 0.5, 0.4, 0.6, 0.7, 0.1, 0, 0.0, 0.0, 0.05)
    engine.section.get(2).set_offset("Middle", 0.0, "Top", 0.0)
    engine.section.get(2).set_mesh(0, 0.1)
    engine.section.create(3, "加厚截面", "TGIRDER", "Middle", 1.5, 1.125, 0.8, 0.0, 0.2, 0.25, 0.5, 0.4, 0.6, 0.7, 0.1, 0, 0.0, 0.0, 0.05)
    engine.section.get(3).set_offset("Middle", 0.0, "Top", 0.0)
    engine.section.get(3).set_mesh(0, 0.1)
    engine.section.create(5, "截面1", "TGIRDER", "Middle", 1.5, 1.125, 0.8, 0.0, 0.2, 0.25, 0.55, 0.3, 0.6, 0.45, 0.15, 0, 0.0, 0.0, 0.05)
    engine.section.get(5).set_offset("Middle", 0.0, "Top", 0.0)
    engine.section.get(5).set_mesh(0, 0.1)
    engine.section.create(6, "截面2", "TGIRDER", "Middle", 1.5, 1.125, 0.8, 0.0, 0.2, 0.25, 0.55, 0.3, 0.6, 0.45, 0.15, 0, 0.0, 0.0, 0.05)
    engine.section.get(6).set_offset("Middle", 0.0, "Top", 0.0)
    engine.section.get(6).set_mesh(0, 0.1)
    engine.section.create(7, "截面3", "TGIRDER", "Middle", 1.5, 1.125, 0.8, 0.0, 0.2, 0.25, 0.55, 0.3, 0.6, 0.45, 0.15, 0, 0.0, 0.0, 0.05)
    engine.section.get(7).set_offset("Middle", 0.0, "Top", 0.0)
    engine.section.get(7).set_mesh(0, 0.1)
    engine.section.create(8, "截面4", "TGIRDER", "Middle", 1.5, 1.125, 0.8, 0.0, 0.2, 0.25, 0.55, 0.3, 0.6, 0.45, 0.15, 0, 0.0, 0.0, 0.05)
    engine.section.get(8).set_offset("Middle", 0.0, "Top", 0.0)
    engine.section.get(8).set_mesh(0, 0.1)
    engine.section.create(9, "截面5", "TGIRDER", "Middle", 1.5, 1.125, 0.8, 0.0, 0.2, 0.25, 0.55, 0.3, 0.6, 0.45, 0.15, 0, 0.0, 0.0, 0.05)
    engine.section.get(9).set_offset("Middle", 0.0, "Top", 0.0)
    engine.section.get(9).set_mesh(0, 0.1)
    engine.section.create(10, "截面6", "TGIRDER", "Middle", 1.5, 1.125, 0.8, 0.0, 0.2, 0.25, 0.55, 0.3, 0.6, 0.45, 0.15, 0, 0.0, 0.0, 0.05)
    ...
    engine.section.get(1).add_rebar_l(2, "LINEA", 2, "Center", 0.0, "Top", -0.04, 6, 0.1, "D12")
    # 添加或修改抗剪钢筋（按类型分发）
    ...
    engine.section.get(3).add_rebar_l(2, "LINEA", 2, "Center", 0.0, "Top", -0.04, 6, 0.1, "D12")
    ...
    engine.section.get(5).add_rebar_l(2, "LINEA", 2, "Center", 0.0, "Top", -0.04, 6, 0.1, "D12")
    ...
    engine.section.get(6).add_rebar_l(2, "LINEA", 2, "Center", 0.0, "Top", -0.04, 6, 0.1, "D12")
    ...
    engine.section.get(7).add_rebar_l(2, "LINEA", 2, "Center", 0.0, "Top", -0.04, 6, 0.1, "D12")
    ...
    engine.section.get(8).add_rebar_l(2, "LINEA", 2, "Center", 0.0, "Top", -0.04, 6, 0.1, "D12")
    ...
    engine.section.get(9).add_rebar_l(2, "LINEA", 2, "Center", 0.0, "Top", -0.04, 6, 0.1, "D12")
    ...
    engine.section.get(10).add_rebar_l(2, "LINEA", 2, "Center", 0.0, "Top", -0.04, 6, 0.1, "D12")
