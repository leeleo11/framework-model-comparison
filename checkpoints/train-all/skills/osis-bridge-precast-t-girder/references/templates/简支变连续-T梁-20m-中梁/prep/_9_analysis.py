...
def build_analysis(engine: OSISEngine) -> None:
    ...
    engine.settlement.group.create("沉降组2", -0.005, 20)
    engine.settlement.group.create("沉降组3", -0.005, 38)
    engine.settlement.group.create("沉降组4", -0.005, 56)
    # 创建沉降荷载工况
    ...
    engine.live.lane.create("车道", "VE", 19.5, 1.8, 1, 0, "主梁单元", 0.0, 0.0)
    # 创建活载工况
    ...
    engine.live.case.get("车道荷载包络").include("a", "车道荷载工况1", "简支变连续T梁移动荷载", 0.8, 1, "CUSTOM", 4.315, "车道")
    # 设置活载子工况的加载车道数范围
