...
def build_analysis(engine: OSISEngine) -> None:
    ...
    engine.live.lane.create("车道1", "VE", 40.0, 1.8, 1, 0, "车道1车道线单元组", 4.6, 0.0)
    engine.live.lane.create("车道2", "VE", 40.0, 1.8, 1, 0, "车道2车道线单元组", 1.5, 0.0)
    engine.live.lane.create("车道3", "VE", 40.0, 1.8, -1, 0, "车道3车道线单元组", -1.6, 0.0)
    engine.live.lane.create("车道4", "VE", 40.0, 1.8, -1, 0, "车道4车道线单元组", -4.7, 0.0)
    # 创建活载工况
