...
def build_analysis(engine: OSISEngine) -> None:
    # 创建或修改沉降组
    engine.settlement.group.create(1, -0.005, 2, 4, 5, 7)
    # 创建沉降荷载工况
    ...
    engine.live.lane.create("1_", "VE", 40.0, 1.8, 1, 0, "1_车道线单元组", 8.39, 0.0)
    engine.live.lane.create("2_", "VE", 40.0, 1.8, 1, 0, "2_车道线单元组", 5.29, 0.0)
    engine.live.lane.create("3_", "VE", 40.0, 1.8, 1, 0, "3_车道线单元组", 2.19, 0.0)
    engine.live.lane.create("4_", "VE", 40.0, 1.8, 1, 0, "4_车道线单元组", -0.91, 0.0)
    engine.live.lane.create("5_", "VE", 40.0, 1.8, 1, 0, "5_车道线单元组", -4.01, 0.0)
    # 创建活载工况
