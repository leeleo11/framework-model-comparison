...
def build_analysis(engine: OSISEngine) -> None:
    ...
    engine.live.lane.create("1_", "VE", 25.0, 1.8, 1, 0, "1_车道线单元组", 6.475, 0.0)
    engine.live.lane.create("2_", "VE", 25.0, 1.8, 1, 0, "2_车道线单元组", 3.375, 0.0)
    engine.live.lane.create("3_", "VE", 25.0, 1.8, 1, 0, "3_车道线单元组", 0.275, 0.0)
    engine.live.lane.create("4_", "VE", 25.0, 1.8, 1, 0, "4_车道线单元组", -2.825, 0.0)
    # 创建活载工况
    ...
    engine.live.case.get("公路一级").include("a", "公路一级_sub1", "CH-CD", 1.0, 1, "CUSTOM", 0.85, "1_", "2_", "3_", "4_")
    # 设置活载子工况的加载车道数范围
    engine.live.case.get("公路一级").set_lane_count("公路一级_sub1", 0, 4)
