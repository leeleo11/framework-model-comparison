...
def build_elements(engine: OSISEngine) -> None:
    ...
    # 分配或重置单个单元的理论厚度
    engine.prop.assign_component_thickness(0.4177, "a", "1to75")
    # 创建单元组
    engine.element.group.create("1_车道线单元组", "c")
    engine.element.group.create("1_车道线单元组", "a", "1to75")
    engine.element.group.create("2_车道线单元组", "c")
    engine.element.group.create("2_车道线单元组", "a", "1to75")
    engine.element.group.create("3_车道线单元组", "c")
    engine.element.group.create("3_车道线单元组", "a", "1to75")
    engine.element.group.create("B1单元组", "c")
    engine.element.group.create("B1单元组", "a", "1to75")
    engine.element.group.create("B2单元组", "c")
    engine.element.group.create("B2单元组", "a", "1to75")
    engine.element.group.create("横隔板", "c")
    engine.element.group.create("全桥", "c")
    engine.element.group.create("全桥", "a", "1to75")
    engine.element.group.create("支点", "c")
