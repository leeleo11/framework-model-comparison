...
def build_analysis(engine: OSISEngine) -> None:
    ...
    engine.live.lane.create("车道1", "VE", 30.0, 1.8, 1, 0, "车道1车道线单元组", 4.45, 0.0)
    engine.live.lane.create("车道2", "VE", 30.0, 1.8, 1, 0, "车道2车道线单元组", 1.3, 0.0)
    engine.live.lane.create("车道3", "VE", 30.0, 1.8, 1, 0, "车道3车道线单元组", -1.85, 0.0)
    # 创建活载工况
